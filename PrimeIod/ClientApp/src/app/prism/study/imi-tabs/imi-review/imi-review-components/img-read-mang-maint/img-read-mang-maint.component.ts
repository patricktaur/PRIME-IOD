...
@Component({
  selector: 'app-img-read-mang-maint',
  templateUrl: './img-read-mang-maint.component.html',
  styleUrls: ['./img-read-mang-maint.component.css']
})
export class ImgReadMangMaintComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
