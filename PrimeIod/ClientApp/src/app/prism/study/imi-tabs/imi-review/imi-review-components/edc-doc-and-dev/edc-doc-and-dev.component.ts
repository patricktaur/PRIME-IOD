...
@Component({
  selector: 'app-edc-doc-and-dev',
  templateUrl: './edc-doc-and-dev.component.html',
  styleUrls: ['./edc-doc-and-dev.component.css']
})
export class EdcDocAndDevComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
