...
@Component({
  selector: 'app-miles-stones-timelines',
  templateUrl: './miles-stones-timelines.component.html',
  styleUrls: ['./miles-stones-timelines.component.css']
})
export class MilesStonesTimelinesComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
