...
@Component({
  selector: 'app-cross-functional',
  templateUrl: './cross-functional.component.html',
  styleUrls: ['./cross-functional.component.css']
})
export class CrossFunctionalComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
