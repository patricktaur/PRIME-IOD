...
import { cdmstasksfilters } from '@app/prism/admin/admin-cdms/cdms-tasks/cdms-tasks-filter/cdmstasksfilters';

@Component({
  selector: 'app-cdms-tasks-list',
  templateUrl: './cdms-tasks-list.component.html',
  styleUrls: ['./cdms-tasks-list.component.css']
})
export class CdmsTasksListComponent implements OnInit {
  title = 'abcd';
  isLoading = false;
  records: any;
  ...
  selectedFilters: cdmstasksfilters = {
    pageNumber: 1,
    pageSize: 10
    // iconNumberOrName: '',
    // canLoginId: [],
  ...
  constructor(
    ...
    private cdmstasksService: cdmstasksService // public actRoute: ActivatedRoute, // public studyEditService: StudyEditAService
  ) {
  ...
  onFilterChange(filters: cdmstasksfilters) {
