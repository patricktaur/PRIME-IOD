...
@Component({
  selector: 'app-study-startup',
  templateUrl: './study-startup.component.html',
  styleUrls: ['./study-startup.component.css']
})
export class StudyStartupComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
