...
@Component({
  selector: 'app-cds-del-req-dash-n-list',
  templateUrl: './cds-del-req-dash-n-list.component.html',
  styleUrls: ['./cds-del-req-dash-n-list.component.css']
})
export class CdsDelReqDashNListComponent implements OnInit {
  dueType: string | any;
  item: any;
