...
@Component({
  selector: 'app-cds-validation-filter',
  templateUrl: './cds-validation-filter.component.html',
  styleUrls: ['./cds-validation-filter.component.css']
})
export class CdsValidationFilterComponent implements OnInit, OnDestroy {
  // @Input() requiredPermissions: any;
  // @Input() selectedFilters: any;

  @Input() selectedFilters: CdsValPaginationAndFilters = {
    pageNumber: 1,
    pageSize: 10,
    searchOn: 'task-id',
    sortOn: 'task-id',
