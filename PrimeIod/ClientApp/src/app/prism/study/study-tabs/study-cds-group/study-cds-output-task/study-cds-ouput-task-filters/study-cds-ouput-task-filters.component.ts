...
@Component({
  selector: 'app-study-cds-ouput-task-filters',
  templateUrl: './study-cds-ouput-task-filters.component.html',
  styleUrls: ['./study-cds-ouput-task-filters.component.css']
})
export class StudyCdsOuputTaskFiltersComponent implements OnInit, OnDestroy {
