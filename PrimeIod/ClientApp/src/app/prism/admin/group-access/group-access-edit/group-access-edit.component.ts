...
@Component({
  selector: 'app-group-access-edit',
  templateUrl: './group-access-edit.component.html',
  styleUrls: ['./group-access-edit.component.css']
})
export class AppAccessGroupEditComponent implements OnInit, OnDestroy {
  loading = false;
  title = 'Access Group';
