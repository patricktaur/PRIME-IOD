...
export class AppAccessGroupService {
  controllerName = 'TblAppAccessGroup';
  ...
  // updateGroupMembers(groupMembers: any) {
  //   const api = `${environment.serverUrl}/api/${this.controllerName}/group-members-update/`;
