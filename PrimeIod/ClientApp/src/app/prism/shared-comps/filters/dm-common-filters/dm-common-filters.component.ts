...
@Component({
  ...
  templateUrl: './dm-common-filters.component.html',
  styleUrls: ['./dm-common-filters.component.css']
})
export class DMCommonFilterComponent implements OnInit {
  ...
  get filterRecords() {
    ...
    if (this.dmpmManagerFilters && this.dmpmManagerFilters.length > 0) {
      ...
      filter6 = filter5.filter((n: any) => this.dmpmManagerFilters.some((v: any) => n.currentDmpmManager?.includes(v)));
    }
