import { Component, OnInit, Input, Output, EventEmitter, ɵCurrencyIndex } from '@angular/core';
import { FormGroup } from '@angular/forms';
import { FormlyFormOptions, FormlyFieldConfig } from '@ngx-formly/core';
import { FormlyService } from '@app/shared/formly/services/formly.service';

@Component({
  selector: 'app-proj-stat-dash-review',
  templateUrl: './proj-stat-dash-review.component.html',
  styleUrls: ['./proj-stat-dash-review.component.css']
})
export class ProjStatDashReviewComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
  ...
  ngOnInit(): void {
    this.filteredRecord = this.record?.filter((n: any) => n.fieldParId === this.parid);
    this.record = this.filteredRecord;
