...
@Component({
  selector: 'app-imi-study-request-request-list',
  templateUrl: './imi-study-request-request-list.component.html',
  styleUrls: ['./imi-study-request-request-list.component.css']
})
export class ImiStudyRequestRequestListComponent implements OnInit {
  title = 'abcd';
  isLoading = false;
  records: any;
