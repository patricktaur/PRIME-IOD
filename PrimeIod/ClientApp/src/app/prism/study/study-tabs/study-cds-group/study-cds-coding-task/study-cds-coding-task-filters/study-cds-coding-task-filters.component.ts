...
@Component({
  selector: 'app-study-cds-coding-task-filters',
  templateUrl: './study-cds-coding-task-filters.component.html',
  styleUrls: ['./study-cds-coding-task-filters.component.css']
})
export class StudyCdsCodingTaskFiltersComponent implements OnInit, OnDestroy {
