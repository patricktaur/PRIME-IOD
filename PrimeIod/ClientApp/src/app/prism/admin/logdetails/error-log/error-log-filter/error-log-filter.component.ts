...
@Component({
  selector: 'app-error-log-filter',
  templateUrl: './error-log-filter.component.html',
  styleUrls: ['./error-log-filter.component.css']
})
export class ErrorLogFilterComponent implements OnInit {
