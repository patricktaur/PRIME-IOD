...
@Component({
  selector: 'app-reader-training',
  templateUrl: './reader-training.component.html',
  styleUrls: ['./reader-training.component.css']
})
export class ReaderTrainingComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
