...
{
    public class vwReportThirdPartyCDMSTaskListV2_Columns : IReportColumns
    {
        public UIGridProperties GetReportColumns()
        {
            ...
            new UIGridProperties{
                //CodeBlockStart
                Title = "Clininfo CDMS Task (List)",
FilterGroup = 16, //server side pagination, client side filter: 8,
