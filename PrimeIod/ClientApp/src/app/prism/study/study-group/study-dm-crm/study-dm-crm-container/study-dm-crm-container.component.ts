...
@Component({
  selector: 'app-study-dm-crm-container',
  templateUrl: './study-dm-crm-container.component.html',
  styleUrls: ['./study-dm-crm-container.component.css']
})
export class StudyDmCrmContainerComponent implements OnInit {
  rootPath = 'study/dm-crm'
  studyProperties: any;
  studyId: number = 0;
