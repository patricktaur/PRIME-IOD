...
@Component({
  selector: 'app-cds-instructions-filter',
  templateUrl: './cds-instructions-filter.component.html',
  styleUrls: ['./cds-instructions-filter.component.css']
})
export class CdsInstructionsFilterComponent implements OnInit, OnDestroy {
  // @Input() requiredPermissions: any;
  // @Input() selectedFilters: any;
  @Input() selectedFilters: CdsInstrPaginationAndFilters = {
    pageNumber: 1,
    pageSize: 10,
    searchOn: 'task-id',
    sortOn: 'task-id',
