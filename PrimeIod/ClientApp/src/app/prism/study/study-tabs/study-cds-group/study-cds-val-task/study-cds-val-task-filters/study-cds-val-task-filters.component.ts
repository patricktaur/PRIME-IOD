...
@Component({
  selector: 'app-study-cds-val-task-filters',
  templateUrl: './study-cds-val-task-filters.component.html',
  styleUrls: ['./study-cds-val-task-filters.component.css']
})
export class StudyCdsValTaskFiltersComponent implements OnInit, OnDestroy {
  ...
  loadFilters() {
    //Note: Development Category Filter:
