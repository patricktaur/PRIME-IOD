...
@Component({
  selector: 'app-quality-and-tmf',
  templateUrl: './quality-and-tmf.component.html',
  styleUrls: ['./quality-and-tmf.component.css']
})
export class QualityAndTmfComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
