...
@Component({
  selector: 'app-process-improvement-tracker-view',
  templateUrl: './process-improvement-tracker-view.component.html',
  styleUrls: ['./process-improvement-tracker-view.component.css']
})
export class ProcessImprovementTrackerViewComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private dataService: ProcessImprovementTrackerService // private requestIdService: StudyCdsRequestIdService
  ) {}
