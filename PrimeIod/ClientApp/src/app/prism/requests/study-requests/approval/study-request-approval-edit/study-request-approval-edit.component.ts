...
@Component({
  selector: 'app-study-request-approval-edit',
  templateUrl: './study-request-approval-edit.component.html',
  styleUrls: ['./study-request-approval-edit.component.css']
})
export class StudyRequestApprovalEditComponent implements OnInit {
  loading: boolean = false;
  title = 'Approve request to create new Study';
  ...
  approve() {
    ...
    this.addUpdateSub = this.requestsService.dmApprove(this.record).subscribe(
      res => {
        this.form.reset();
        this.location.back();
        this.loading = false;
