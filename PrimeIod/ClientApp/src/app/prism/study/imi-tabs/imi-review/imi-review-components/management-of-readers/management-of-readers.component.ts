...
@Component({
  selector: 'app-management-of-readers',
  templateUrl: './management-of-readers.component.html',
  styleUrls: ['./management-of-readers.component.css']
})
export class ManagementOfReadersComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
