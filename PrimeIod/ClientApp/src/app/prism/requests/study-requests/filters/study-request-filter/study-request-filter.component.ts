...
@Component({
  selector: 'app-study-request-filter',
  templateUrl: './study-request-filter.component.html',
  styleUrls: ['./study-request-filter.component.css']
})
export class StudyRequestFilterComponent implements OnInit {
