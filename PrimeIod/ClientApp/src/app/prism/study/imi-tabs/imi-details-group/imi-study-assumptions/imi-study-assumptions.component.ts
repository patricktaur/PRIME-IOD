...
@Component({
  selector: 'app-imi-study-assumptions',
  templateUrl: './imi-study-assumptions.component.html',
  styleUrls: ['./imi-study-assumptions.component.css']
})
export class ImiStudyAssumptionsComponent implements OnInit, OnDestroy {
  studyId: number = 0;
  ...
  ngOnInit(): void {
    ...
    //   this.studyId = st;
    //   if (this.studyId > 0) {
    //     this.loadStudyAssumptions(this.studyId);
    //   }
    // });
