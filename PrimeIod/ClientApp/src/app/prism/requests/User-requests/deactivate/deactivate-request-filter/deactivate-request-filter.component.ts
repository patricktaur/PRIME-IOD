...
@Component({
  selector: 'app-deactivate-request-filter',
  templateUrl: './deactivate-request-filter.component.html',
  styleUrls: ['./deactivate-request-filter.component.css']
})
export class DeactivateRequestFilterComponent implements OnInit {
