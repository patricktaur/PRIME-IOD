...
export class DBkeys {
  ...
  public static readonly MENU_PERMISSIONS = 'menu_permissions';
  public static readonly COMPONENT_PERMISSIONS = 'component_permissions';
  ...
  public static readonly SELECTED_ROLE = 'selected_role';
