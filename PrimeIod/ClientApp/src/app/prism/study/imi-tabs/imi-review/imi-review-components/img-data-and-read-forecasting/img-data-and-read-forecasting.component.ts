...
@Component({
  selector: 'app-img-data-and-read-forecasting',
  templateUrl: './img-data-and-read-forecasting.component.html',
  styleUrls: ['./img-data-and-read-forecasting.component.css']
})
export class ImgDataAndReadForecastingComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
