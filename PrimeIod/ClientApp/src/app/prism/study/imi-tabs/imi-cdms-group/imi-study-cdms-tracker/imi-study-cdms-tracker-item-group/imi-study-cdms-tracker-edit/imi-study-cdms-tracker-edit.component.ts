...
@Component({
  selector: 'app-imi-study-cdms-tracker-edit',
  templateUrl: './imi-study-cdms-tracker-edit.component.html',
  styleUrls: ['./imi-study-cdms-tracker-edit.component.css']
})
export class ImiStudyCdmsTrackerEditComponent implements OnInit, OnDestroy {
  title = 'ImiStudyCdmsTracker';
  controllerName = 'TblImicdmsTasksTimelinesTrackerMainRecords';
  ...
  constructor(
    ...
    private cdmsTrackerService: ImiCdmsTrackerService,
    @Inject('imi-cdms-tracker') private serverResponseService: ServerResponseService // @Inject('cdms-tracker') private serverResponseService: ServerResponseService
  ) { }
