...
@Component({
  selector: 'app-crm-study-approval-list',
  templateUrl: './crm-study-approval-list.component.html',
  styleUrls: ['./crm-study-approval-list.component.css']
})
export class CrmStudyApprovalListComponent implements OnInit {
  title = 'abcd';
  isLoading = false;
  records: any;
  ...
  edit(id: number) {
    this.router.navigate(['crm-study-approval-edit'], { relativeTo: this.actRoute.parent, queryParams: { id: id } });
  }
