...
export class CrmStudyResourcesDataService {
  constructor() {}
  ...
  resourceRoles = [
    { recId: UserRoles.CRM_Central_Monitor, description: 'Central Monitor' },
    { recId: UserRoles.CRM_Clinical_Data_Analyst, description: 'Clinical Data Analyst' },
    { recId: UserRoles.CRM_Clinical_Data_Analyst_Sr, description: 'Sr. Clinical Data Analyst' },
    { recId: UserRoles.CRM_Clinical_Risk_Manager, description: 'Clinical Risk Manager' },
    { recId: UserRoles.CRM_Clinical_Risk_Manager_Sr, description: 'Sr. Clinical Risk Manager' },
    { recId: UserRoles.CRM_Director_Sr, description: 'Sr. Director' },
  ];
}
