...
@Component({
  selector: 'app-region-imi-filter',
  templateUrl: './region-imi-filter.component.html',
  styleUrls: ['./region-imi-filter.component.css']
})
export class RegionImiFilterComponent implements OnInit {
