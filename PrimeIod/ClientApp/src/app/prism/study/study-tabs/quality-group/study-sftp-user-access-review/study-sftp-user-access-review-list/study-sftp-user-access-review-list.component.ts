...
@Component({
  selector: 'app-study-sftp-user-access-review-list',
  templateUrl: './study-sftp-user-access-review-list.component.html',
  styleUrls: ['./study-sftp-user-access-review-list.component.css']
})
export class StudySftpUserAccessReviewListComponent extends StudyListBase implements OnInit {
  ...
  columns: Array<any> = [
    ...
    {
      header: 'SFtp Access Review Periodicity *',
      field: 'sFtpAccessReviewPeriodicity',
      type: 'number',
      align: 'right'
    },
    // {
