...
@Component({
  selector: 'app-resourcing-and-staff-eng',
  templateUrl: './resourcing-and-staff-eng.component.html',
  styleUrls: ['./resourcing-and-staff-eng.component.css']
})
export class ResourcingAndStaffEngComponent implements OnInit {
  @Input() record: any = {};
  @Input() form: any = {};
